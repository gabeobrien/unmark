...
<head>
    ...
    <link rel="icon" type="/unmarkimage/ico" href="favicon.ico" />
...
<div class="mark-added" data-label="<?php print $mark->label_id; ?>" data-label-name="<?php print $mark->label_name; ?>">
    ...
    <div class="mark-added-info">
        ...
        <span>INFO::URL::<?php print niceUrl($mark->url); ?></span>
    </div>

    <div class="mark-added-label mark-added-settings">
        <span id="label-chosen"></span>
        <a id="currLabel" class="action" data-action="marks_addLabel" href="/unmark/#"><?php echo _('Unlabeled'); ?></a>
    ...
    <div class="mark-added-note mark-added-settings">
        <?php if (empty($mark->notes)) : ?>
            <a class="action" data-action="marks_addNotes" href="/unmark/"><?php echo _('Add a Note or Edit Title'); ?></a>
...
<script src="/unmark/assets/libraries/jquery/jquery-2.1.0.min.js"></script>
<script src="/unmark/assets/js/production/unmark.bookmarklet.js?v=<?php echo ASSET_VERSION; ?>"></script>
