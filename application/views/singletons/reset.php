...
<head>
    ...
    <link rel="stylesheet" href="/unmark/css/unmark.css?v=<?php echo ASSET_VERSION; ?>" />
...
<script src="/unmark/assets/js/production/unmark.loggedout.js?v=<?php echo ASSET_VERSION; ?>"></script>
