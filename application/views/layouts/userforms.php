<div id="helperforms">
    <div id="resetPasswordForm" class="resetWrapper hiddenform">
        <div class="loginInner">
            ...
            <form id="send_password_change" method="post" action="/unmark/#" class="ajaxsbmt">
    ...
    <div id="changePasswordForm" class="resetWrapper hiddenform">
        <div class="loginInner">
            ...
            <form id="send_email_change" method="post" action="/unmark/#" class="ajaxsbmt">
    ...
    <div id="importExportForm" class="resetWrapper hiddenform">
        <div class="loginInner">
            ...
            <a data-action="export_data" class="exportbtn action" href="/unmark/#"><?php echo _('Export File') ?></a>
            <h1><?php echo _('Import Marks') ?></h1>
            <form id="importForm" method="post" enctype="multipart/form-data" action="/unmark/import">
                <input id="importerUnmark" class="importer" type="file" name="upload">
                <a data-action="import_data" class="importbtn action" href="/unmark/#"><?php echo _('Import Unmark File') ?></a>
            </form>
            <form id="importFormReadability" method="post" enctype="multipart/form-data" action="/unmark/import">
                <input id="importerReadability" class="importer" type="file" name="uploadReadability">
                <a data-action="import_data_readability" class="importbtn action" href="/unmark/#"><?php echo _('Import Readability File') ?></a>
            </form>
